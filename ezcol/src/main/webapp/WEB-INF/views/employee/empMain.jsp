		...
		<div class="content three_quarter first" id="content">
			...
			<div class="scrollable">
				...
				<table>
					...
					<tbody>
						...
						<c:forEach var="employee" items="${ list }">
							...
							<tr onclick="location.href='detailEmp.do?empno=${employee.empno}'" style="cursor: pointer"
								class="tr">
				...
				<div style="text-align: center; margin-top: 50px;">
					...
					<button type="button" onclick="location.href='insertEmpForm.do'">직원 추가</button>
