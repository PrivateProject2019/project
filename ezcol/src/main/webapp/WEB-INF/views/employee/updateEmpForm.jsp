...
<body id="top">
					...
					<table>
						<tr>
							...
							<td><input type="text" name="empno"
								value="${ employee.empno }" readonly size="25"></td>
							<th>부서</th>

							<td><select name="belong">
									<option value="행정부">행정부</option>
									<option value="학생지원부">학생지원부</option>
									<option value="시설부">시설부</option>
									<option value="교과부">교과부</option>
						...
						<tr>
							<th>주민등록번호</th>
							<td><input type="text" name="ssn" value="${employee.ssn }"></td>
							<th>이메일</th>
							<td><input type="email" size="23" name="email"
								value="${employee.email }" required></td>
						...
						<tr>
							...
							<td><input type="text" name="emergency"
								value="${employee.emergency }" required></td>
						</tr>
						<tr>
							...
							<td colspan="3">
								...
								type="text" name="address" value="${employee.address }" readonly>
							</td>
						...
						<tr>
							...
							<td id="postcode" style="border-right-style: none;" colspan="2"><input
								type="text" name="post" value="${employee.post }" readonly></td>
							<!-- 서블렛에 보낼 우편번호값 -->
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="detailaddress"
								size="60" value="${employee.detailaddress }" required></td>
	...
	<script type="text/javascript">
		$(function() {
			...
			//부서 부분 
			$("select[name=belong] option").each(function() {

				if ($(this).val() == '${employee.belong}') {
			...
			//직급부분 
			$("select[name=job] option").each(function() {

				if ($(this).val() == '${employee.job}') {
					$(this).attr("selected", "selected");
				}
