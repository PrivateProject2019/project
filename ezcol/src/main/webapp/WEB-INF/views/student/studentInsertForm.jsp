...
<body id="top">
			...
			<div class="scrollable">
				...
				<input type="hidden" name="${_csrf.parameterName}"
					...
					<table>
						<tr>
							<th>학번</th>
							<td><input type="text" size="25" name="studentno" required></td>
							<th>학과코드</th>

							<td>
							<input type="text" name=deptno placeholder="Ex)D1111" size="5" maxlength="8" required>
							<div id="deptname" style="color: red"></div>
							</td>
						</tr>
						<tr>
							<th>학생이름</th>
							<td><input type="text" size="15" name="name" required></td>
							<th>학적상태</th>
						...
						<tr>
							...
							<td><input type="text" name="ssn"
								placeholder="Ex)123456-1111111"></td>
							<th>담당교수</th>
							<td>
							<input type="text" name="teacherno" placeholder="Ex)P1111" size="5" maxlength="8" required>
						...
						<tr>
							<th>이메일</th>
							<td><input type="email" size="23" name="email" required></td>
							<th>학년</th>
							<td><input type="number"min="1" max="4" name="grade" size="30" required></td>
						</tr>

						<tr>
							<th>전화번호</th>
							<td colspan=""><input type="text" name="phone" required
								placeholder="(ex) 01033331111"></td>
							<th>비상연락망</th>
							<td><input type="text" name="emergency" required></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td id="postcode" style="border-right-style: none;" colspan="2"><input
								type="text" name="post" readonly></td>
							<!-- 서블렛에 보낼 우편번호값 -->
					...
					<div style="text-align: center; margin-top: 50px;">
						...
						<button type="submit" onclick="return validate()">완료</button>
	...
	<script type="text/javascript">
		...
		function validate() {
			...
			if ($("input[name=ssn]").val().indexOf("-") == -1) {
