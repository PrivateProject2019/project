		...
		<div class="content three_quarter first" id="content">
			...
			<div class="scrollable">
				...
				<table>
					...
					<tbody>
						...
						<c:forEach var="student" items="${ list }">
							...
							<tr onclick="location.href='detailStudent.do?studentno=${student.studentno}'" style="cursor: pointer"
								class="tr">
				...
				<div style="text-align: center; margin-top: 50px;">
					...
					<button type="button" onclick="location.href='insertStudentForm.do'">학생 추가</button>
				...
				<div style="text-align: center; margin-top: 50px;">
					...
					<div id="paging">
						...
						<c:forEach var="num" begin="${ paging.startPage }"
							...
							<a href="studentMain.do?currentPage=${num}">${num}</a>
						...
						<c:forEach var="num" begin="${ paging.startPage }"
							...
							<a href="searchStudent.do?currentPage=${num}&keyword=${ keyword }">${num}</a>
