			...
			<div class="scrollable">
				...
				<input type="hidden" name="${_csrf.parameterName}"
					...
					<table>
						<tr>
							<th>학번</th>
							<td><input type="text" size="25" name="studentno"
								value="${ student.studentno }"></td>
							<th>학과코드</th>

							<td><input type="text" name=deptno
								value="${ student.deptno }" required></td>
						</tr>
						<tr>
							<th>학생이름</th>
							<td><input type="text" size="15" name="name"
								value="${student.name }" required></td>
							<th>학적상태</th>
						...
						<tr>
							...
							<td><input type="email" size="23" name="email"
								value="${ student.email }" required></td>
							<th>학년</th>
							<td><input type="number" min="1" max="4" name="grade"
								size="30" value="${ student.grade }"></td>
						</tr>

						<tr>
							<th>전화번호</th>
							<td colspan=""><input type="text" name="phone" required
								placeholder="(ex) 01033331111" value="${ student.phone }"></td>
							<th>비상연락망</th>
							<td><input type="text" name="emergency"
								value="${ student.emergency }" required></td>
						</tr>
						<tr>
							...
							<td colspan="3">
								...
								type="text" name="address" value="${ student.address }" readonly>
							</td>
						...
						<tr>
							...
							<td id="postcode" style="border-right-style: none;" colspan="2"><input
								type="text" name="post" value="${student.post }" readonly></td>
							<!-- 서블렛에 보낼 우편번호값 -->
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="detailaddress"
								size="60" value="${ student.detailaddress }" required></td>
